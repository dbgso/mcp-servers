...
Add mcp-shared-graph-viz: hand it nodes and edges, get an interactive page. Mapping a domain onto nodes and edges stays with the caller; the library holds no domain knowledge.
