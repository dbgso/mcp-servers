...
describe("RuleEngine", () => {
  describe("evaluate", () => {
    test("should return default action when no rules match", () => {
      ...
      const result = engine.evaluate({ toolName: "some_tool", args: {} });
    ...
    test("should match exact tool name", () => {
      ...
      const result = engine.evaluate({ toolName: "browser_click", args: {} });
    ...
    test("should match glob pattern", () => {
      ...
      expect(engine.evaluate({ toolName: "browser_click", args: {} }).action).toBe("allow");
      expect(engine.evaluate({ toolName: "browser_navigate", args: {} }).action).toBe("allow");
      expect(engine.evaluate({ toolName: "file_read", args: {} }).action).toBe("deny"); // default
    });
    ...
    test("should match wildcard pattern", () => {
      ...
      expect(engine.evaluate({ toolName: "any_tool", args: {} }).action).toBe("allow");
    });
    ...
    test("should evaluate rules by priority (higher first)", () => {
      ...
      const clickResult = engine.evaluate({ toolName: "browser_click", args: {} });
      ...
      const navResult = engine.evaluate({ toolName: "browser_navigate", args: {} });
    ...
    describe("conditions", () => {
      test("should match equals condition", () => {
        ...
        expect(engine.evaluate({ toolName: "browser_click", args: { ref: "dangerous-button" } }).action).toBe("deny");
        expect(engine.evaluate({ toolName: "browser_click", args: { ref: "safe-button" } }).action).toBe("allow");
      });
      ...
      test("should match contains condition", () => {
        ...
        expect(engine.evaluate({ toolName: "browser_click", args: { ref: "delete-all-btn" } }).action).toBe("deny");
        expect(engine.evaluate({ toolName: "browser_click", args: { ref: "btn-delete" } }).action).toBe("deny");
        expect(engine.evaluate({ toolName: "browser_click", args: { ref: "safe-button" } }).action).toBe("allow");
      });
      ...
      test("should match matches (regex) condition", () => {
        ...
        expect(engine.evaluate({ toolName: "browser_click", args: { ref: "danger-delete-btn" } }).action).toBe("deny");
        expect(engine.evaluate({ toolName: "browser_click", args: { ref: "danger-btn" } }).action).toBe("deny");
        expect(engine.evaluate({ toolName: "browser_click", args: { ref: "safe-danger-btn" } }).action).toBe("allow");
      });
      ...
      test("should match exists condition", () => {
        ...
        expect(engine.evaluate({ toolName: "file_write", args: { force: true } }).action).toBe("deny");
        expect(engine.evaluate({ toolName: "file_write", args: { force: false } }).action).toBe("deny");
        expect(engine.evaluate({ toolName: "file_write", args: {} }).action).toBe("allow");
      });
      ...
      test("should require all conditions to match (AND)", () => {
        ...
        expect(engine.evaluate({ toolName: "browser_click", args: { ref: "delete-btn", force: true } }).action).toBe("deny");
        expect(engine.evaluate({ toolName: "browser_click", args: { ref: "delete-btn", force: false } }).action).toBe("allow");
        expect(engine.evaluate({ toolName: "browser_click", args: { ref: "safe-btn", force: true } }).action).toBe("allow");
      });
      ...
      test("should handle nested params with dot notation", () => {
        ...
        expect(engine.evaluate({ toolName: "api_call", args: { options: { method: "DELETE" } } }).action).toBe("deny");
        expect(engine.evaluate({ toolName: "api_call", args: { options: { method: "GET" } } }).action).toBe("allow");
      });
      ...
      test("should handle invalid regex gracefully", () => {
        ...
        expect(engine.evaluate({ toolName: "browser_click", args: { ref: "any-value" } }).action).toBe("allow");
      });
      ...
      test("should handle type mismatch for contains operator", () => {
        ...
        expect(engine.evaluate({ toolName: "api_call", args: { count: 5 } }).action).toBe("allow");
        expect(engine.evaluate({ toolName: "api_call", args: { count: 123 } }).action).toBe("allow");
        // String value should work
        expect(engine.evaluate({ toolName: "api_call", args: { count: "5" } }).action).toBe("deny");
      });
      ...
      test("should handle type mismatch for matches operator", () => {
        ...
        expect(engine.evaluate({ toolName: "api_call", args: { data: { name: "test" } } }).action).toBe("allow");
        // String value should work
        expect(engine.evaluate({ toolName: "api_call", args: { data: "test123" } }).action).toBe("deny");
      });
      ...
      test("should handle array value for contains operator", () => {
        ...
        expect(engine.evaluate({ toolName: "cli_execute", args: { args: ["hello", "--force", "world"] } }).action).toBe("deny");
        expect(engine.evaluate({ toolName: "cli_execute", args: { args: ["--force-push"] } }).action).toBe("deny");
        // Array without matching element should not match
        expect(engine.evaluate({ toolName: "cli_execute", args: { args: ["hello", "world"] } }).action).toBe("allow");
      ...
      test("should handle array value for matches operator", () => {
        ...
        // Array with matching element should match
        expect(engine.evaluate({ toolName: "cli_execute", args: { args: ["s3", "ls", "--profile", "prod"] } }).action).toBe("deny");
        // Array without matching element should not match
        expect(engine.evaluate({ toolName: "cli_execute", args: { args: ["s3", "ls"] } }).action).toBe("allow");
        // Partial match should not work with exact regex
        expect(engine.evaluate({ toolName: "cli_execute", args: { args: ["--profile-name"] } }).action).toBe("allow");
      });
      ...
      test("should handle array index access args[N]", () => {
        ...
        expect(engine.evaluate({ toolName: "cli_execute", args: { args: ["push", "origin", "main"] } }).action).toBe("deny");
        // git push origin feature should be allowed
        expect(engine.evaluate({ toolName: "cli_execute", args: { args: ["push", "origin", "feature"] } }).action).toBe("allow");
        // git pull origin main should be allowed (args[0] != "push")
        expect(engine.evaluate({ toolName: "cli_execute", args: { args: ["pull", "origin", "main"] } }).action).toBe("allow");
      });
      ...
      test("should handle nested array index access options.volume[0]", () => {
        ...
        expect(engine.evaluate({ toolName: "cli_execute", args: {
      ...
      test("should handle missing param value", () => {
        ...
        expect(engine.evaluate({ toolName: "api_call", args: {} }).action).toBe("allow");
        expect(engine.evaluate({ toolName: "api_call", args: { missing: {} } }).action).toBe("allow");
      });
      ...
      test("should handle unknown operator gracefully", () => {
        ...
        expect(engine.evaluate({ toolName: "api_call", args: { value: "test" } }).action).toBe("allow");
      });
      ...
      test("should handle array index on non-array", () => {
        ...
        expect(engine.evaluate({ toolName: "cli_execute", args: { args: "push origin main" } }).action).toBe("allow");
      });
      ...
      test("should handle dot notation on non-object", () => {
        ...
        expect(engine.evaluate({ toolName: "cli_execute", args: { options: "some-string" } }).action).toBe("allow");
      });
      ...
      test("should handle non-string value in contains condition", () => {
        ...
        expect(engine.evaluate({ toolName: "api_call", args: { data: "123" } }).action).toBe("allow");
      });
  ...
  describe("testRule", () => {
    test("should return detailed match info", () => {
      ...
      const result = engine.testRule({ rule: rule, toolName: "browser_click", args: { ref: "delete-btn" } });
  ...
  describe("evaluateAll", () => {
    test("should return all rules with evaluation details", () => {
      ...
      const result = engine.evaluateAll({ toolName: "browser_click", args: { ref: "submit-btn" } });
    ...
    test("should show actual values in condition results", () => {
      ...
      const result = engine.evaluateAll({ toolName: "cli_execute", args: { options: { profile: "dev" } } });
    ...
    test("should use default action when no rules match", () => {
      ...
      const result = engine.evaluateAll({ toolName: "cli_execute", args: {} });
    ...
    test("should include order number for each rule", () => {
      ...
      const result = engine.evaluateAll({ toolName: "any_tool", args: {} });
