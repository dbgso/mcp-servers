...
describe("AuditLogger", () => {
  ...
  describe("logDeny", () => {
    test("should log deny action", () => {
      ...
      logger.logDeny({ toolName: "browser_click", args: { ref: "delete-btn" }, rule: rule, reason: "Matched block-rule" });
  ...
  describe("logAsk", () => {
    test("should log ask action", () => {
      ...
      logger.logAsk({ toolName: "browser_click", args: { ref: "submit-btn" }, rule: rule, reason: "Requires approval" });
  ...
  describe("logError", () => {
    test("should log error", () => {
      ...
      logger.logError({ toolName: "browser_click", args: { ref: "btn-1" }, error: "Connection timeout" });
