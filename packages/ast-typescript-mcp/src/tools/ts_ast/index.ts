...
registry.registerAll([
  ...
  wrapHandler({ action: "implementation", handler: new GoToImplementationHandler() }),
  wrapHandler({ action: "type_definition", handler: new GoToTypeDefinitionHandler() }),
  ...
  wrapHandler({ action: "params_to_object", handler: new ParamsToObjectHandler() }),
