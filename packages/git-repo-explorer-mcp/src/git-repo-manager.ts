 ...
 */
async function cloneRepo(params: { repoUrl: string; repoPath: string }): Promise<void> {
  const { repoUrl, repoPath } = params;
 ...
 */
export async function gitLsFiles(params: {
  repoPath: string;
  ref?: string;
  options?: LsFilesOptions;
}): Promise<string[]> {
  const { repoPath, ref = "HEAD", options = {} } = params;
 ...
 */
export async function gitBlame(params: {
  repoPath: string;
  ref?: string;
  filePath: string;
  options?: BlameOptions;
}): Promise<string> {
  const { repoPath, ref = "HEAD", filePath, options = {} } = params;
...
export async function gitShow(params: {
  ...
  const { repoPath, ref, filePath } = params;
...
export async function gitDiff(params: {
  ...
  const { repoPath, refFrom, refTo, options = {} } = params;
 ...
 */
export async function gitBranchList(params: {
  repoPath: string;
  options?: BranchListOptions;
}): Promise<string[]> {
  const { repoPath, options = {} } = params;
 ...
 */
export async function gitTagList(params: {
  repoPath: string;
