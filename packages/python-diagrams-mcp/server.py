...
"""
        ...
        # Return as base64 text for client to decode and save
        ...
        # Always return base64 with metadata for client-side decoding
        # This allows Claude to decode and write to file without volume mount
        response_text = f"""## Diagram Generated
...
To save this file, decode the base64 content above and write to a file with the appropriate extension (.{output_format})."""

        contents.append(TextContent(type="text", text=response_text))
